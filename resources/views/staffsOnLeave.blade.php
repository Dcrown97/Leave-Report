                ...
                <div class="card-box">
                    ...
                    <div class="card-body ">
                        <div id="example4_filter" class="dataTables_filter" style="margin-bottom: 10px">
                            ...
                            <input type="search" class="form-control form-control-sm" placeholder="Search" aria-controls="example4">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle" id="example4">
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>{{$staff_on_leave->staff->first_name. ' '.$staff_on_leave->staff->last_name }}</td>
                                    ...
                                    <td class="left">{{ $staff_on_leave->leave_type->id == 1 || $staff_on_leave->leave_type->id == 2?  30 - $staff_on_leave->leave_type->num_of_days: 90 - $staff_on_leave->num_of_days}}</td>
                                    <td>
