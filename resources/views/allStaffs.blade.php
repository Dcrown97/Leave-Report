                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-6">
                                                    <div id="example4_filter" class="dataTables_filter">
                                                        <label>
                                                            <input type="text" style="margin-bottom: 10px" class="form-control form-control-sm" placeholder="Search" aria-controls="example4" id="search">
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td>
                                                            <div class="profile-userbuttons">
                                                                <a href="/leave_request/{{ base64_encode($staff->id) }}" class="btn btn-circle deepPink-bgcolor btn-sm">Request
                                                                    Leave</a>
                                                            </div>
                                                        </td>
                                                    </tr>
