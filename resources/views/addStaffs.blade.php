            ...
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li><a class="parent-item" href="/all_staffs">Staff</a>&nbsp;<i class="fa fa-angle-right"></i>
                        </li>
                            ...
                            <form action="{{ route('add_staffs') }}" method="POST" id="form_sample_1"
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-5">
                                            <input type="number" name="leave_days" data-required="1" value="30" placeholder="Enter Leave Days"
                                                class="form-control input-height" />
                                        </div>
                                    </div>
